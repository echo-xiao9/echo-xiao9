...
- [Aria Gen2 Pilot Dataset](https://github.com/facebookresearch/projectaria_gen2_pilot_dataset?tab=readme-ov-file). The first dataset contains multimodal sensor data from Project Aria Gen2 glasses, including raw sensor streams, real-time machine perception outputs, and post-processed algorithm results, present at ICCV 2025.
